...
Перекладено [Create: Simulated Thrusters](https://www.curseforge.com/minecraft/mc-mods/create-simulated-thrusters), [The Porkchop Express](https://modrinth.com/mod/porkchop-express), [Create Cardan Shafts](https://www.curseforge.com/minecraft/mc-mods/create-cardan-shafts), [Create: Horizontal Chute](https://www.curseforge.com/minecraft/mc-mods/create-addon-horizontal-chute), [Sable Beyond](https://modrinth.com/mod/sable_beyond), [Create: Transmission!](https://modrinth.com/mod/create-transmission!)

Покращено переклад  <br>
Оновлено переклад  <br>
Оновлено і покращено переклад [Create: Power Grid](https://modrinth.com/mod/power-grid), [Create: Bits 'n' Bobs](https://modrinth.com/mod/create-bits-n-bobs)
